            ...
            <div class="p-3 border-l-2 border-b-0 border-r-2">
                ...
                {{-- Begin Title Input--}}
                    ...
                    <div class="mb-2">
                        ...
                        <input id="description" type="text" class="w-full mt-2 rounded h-8 p-1 border text-gray-600 text-sm {{ $errors->has('description') ? 'border-red-500' : 'border' }}" name="description" value="{{ old('description') }}" autofocus>
