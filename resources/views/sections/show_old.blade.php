        ...
        <div id="accordion" class="hidden sm:block border-0 p-0"> 
                ...
                @if ($sectionAssignments->count() > 0)
                    ...
                    @foreach ($sectionAssignments as $assignment)
                        ...
                        {{-- <a href="{{route('assignment-show@show', ['assignment' => $assignment->id , 'section' => $currentSection->id])}}" class="text-gray-600 no-underline font-bold text-sm hover:text-red-500"> --}}
