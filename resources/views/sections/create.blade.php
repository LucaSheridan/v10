            ...
            <div class="p-3 border-l-2 border-b-0 border-r-2">
                ...
                {{-- Max Students Input--}}
                    ...
                    <div class="mb-2">
                        ...
                        <input id="max_students" type="text" class="w-full mt-2 rounded h-8 p-1 border text-gray-600 text-sm {{ $errors->has('max_students') ? 'border-red-500' : 'border' }}" name="max_students" value="{{ old('max_students') }}">
