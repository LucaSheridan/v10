...
//Collection Routes
	...
	//Collection Labels
	Route::get('/collections/{collection}/artifact/{artifact}/editLabel', [CollectionController::class, 'editLabel'])->name('edit-label');
	Route::patch('/collections/{collection}/artifact/{artifact}/updateLabel', [CollectionController::class, 'updateLabel'])->name('update-label');
...
Route::get('/sections/{section}/assignment/{assignment}', [AssignmentController::class, 'show'])->name('show-assignment');
Route::get('/sections/{section}/assignment/{assignment}/edit', [AssignmentController::class, 'edit'])->name('edit-assignment');
Route::patch('/sections/{section}/assignment/{assignment}/update',[AssignmentController::class, 'update'])->name('update-assignment');
Route::delete('sections/{section}/assignment/{assignment}/delete',[AssignmentController::class, 'destroy'])->name('destroy-assignment');;
